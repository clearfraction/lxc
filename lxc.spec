...
Version  : 6.0.0a
Release  : 19
URL      : https://linuxcontainers.org/downloads/lxc/lxc-6.0.0a.tar.gz
Source0  : https://linuxcontainers.org/downloads/lxc/lxc-6.0.0a.tar.gz
Source1  : lxc.tmpfiles
Source2  : https://linuxcontainers.org/downloads/lxc/lxc-6.0.0a.tar.gz.asc
Source3  : C638974D64792D67.pkey
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-2.0 LGPL-2.1
Requires: lxc-bin = %{version}-%{release}
Requires: lxc-config = %{version}-%{release}
...
%setup -q -n lxc-6.0.0
cd %{_builddir}/lxc-6.0.0
pushd ..
cp -a lxc-6.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718788372
...
export GOAMD64=v2
meson --libdir=lib64 --prefix=/usr --buildtype=plain --default-library=static \
...
ninja -v -C builddir
GOAMD64=v3
CFLAGS="$CFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain --default-library=static \
-Dsystemd-unitdir=/usr/lib/systemd/system \
-Dinit-script=systemd \
-Ddistrosysconfdir=/etc/default \
-Dtools-multicall=true \
...
/V3/usr/bin/init.lxc
/V3/usr/bin/lxc
/V3/usr/bin/lxc-attach
/V3/usr/bin/lxc-autostart
/V3/usr/bin/lxc-cgroup
/V3/usr/bin/lxc-checkpoint
/V3/usr/bin/lxc-config
/V3/usr/bin/lxc-console
/V3/usr/bin/lxc-copy
/V3/usr/bin/lxc-create
/V3/usr/bin/lxc-destroy
/V3/usr/bin/lxc-device
/V3/usr/bin/lxc-execute
/V3/usr/bin/lxc-freeze
/V3/usr/bin/lxc-info
/V3/usr/bin/lxc-ls
/V3/usr/bin/lxc-monitor
/V3/usr/bin/lxc-snapshot
/V3/usr/bin/lxc-start
/V3/usr/bin/lxc-stop
/V3/usr/bin/lxc-top
/V3/usr/bin/lxc-unfreeze
/V3/usr/bin/lxc-unshare
/V3/usr/bin/lxc-usernsexec
/V3/usr/bin/lxc-wait
/usr/bin/lxc
/usr/bin/lxc-attach
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/liblxc.so.1.8.0
/usr/lib64/liblxc.so.1
/usr/lib64/liblxc.so.1.8.0

%files libexec
%defattr(-,root,root,-)
/V3/usr/libexec/lxc/hooks/unmount-namespace
/V3/usr/libexec/lxc/lxc-monitord
